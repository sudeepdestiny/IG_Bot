...
chromedriver_path = 'C:/Users/sudeepdestiny/Downloads/chromedriver_win32/chromedriver.exe' # Change this to your own chromedriver path!
...
hashtag_list = ['backpacker', 'wanderlust', 'traveltheworld']

#prev_user_list = [] #if it's the first time you run it, use this line and comment the two below
prev_user_list = pd.read_csv('20200617-134748_users_followed_list.csv', delimiter=',').iloc[:,1:2] # useful to build a user log
        ...
        for x in range(1,200):
            ...
            if username not in prev_user_list:
                ...
                if webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button').text == 'Follow': 
                    ...
                    if comm_prob > 7:
                        comments += 1
                        comment = webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/div[2]/section[1]/span[2]/button')
                        print("select comment_box")
                        comment.click()
                         
                     
                        comment_box = webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/div[2]/section[3]/div/form/textarea')
                        print("Inside comment_box")
                        if (comm_prob < 7):
